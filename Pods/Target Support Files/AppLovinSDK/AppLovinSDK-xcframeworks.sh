...
install_xcframework "${PODS_ROOT}/AppLovinSDK/applovin-ios-sdk-11.1.1/AppLovinSDK.xcframework" "AppLovinSDK" "framework" "ios-arm64_armv7" "ios-arm64_x86_64-simulator"
